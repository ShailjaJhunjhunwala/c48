class Game{
    ...
    async start(){
        ...
        hole1 = createSprite(440,620,40,40)
        hole2 = createSprite(920,140,40,40)
        hole3 = createSprite(440,140,40,40)
        hole4 = createSprite(920,620,40,40)
          ...
          // }
            ...
            for(var i = 0; i<coinsGroup.length; i= i+1){
                if(coinsGroup.get(i).isTouching(striker)){
                    ...
                    if(coinsGroup.get(i).isTouching(hole1)||coinsGroup.get(i).isTouching(hole2)||
                      coinsGroup.get(i).isTouching(hole3)||coinsGroup.get(i).isTouching(hole4)){
                      score = score+10
            }
                }
